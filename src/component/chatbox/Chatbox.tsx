    ...
    return (
      <div className="chatbox__container">
        ...
        <form className="identificationForm" onSubmit={handleToogleIdentification}>
          ...
          <button disabled={isWarnning?false:true} onClick={()=> {handleToogleIdentification}}>Disconnect</button>
        </form>
          ...
          <div ref={targetElementRef} className="corecenter">
            <div className="conversation__container">
              {messages.map((msg, index) => (
                <div key={index}>
                  <p>
                    {msg.sender.replace(userNameRegexName,"")}: {msg.content.replace(userNameRegexinTheMessage,"")}
                  </p>
                </div>
              ))}
            </div>
